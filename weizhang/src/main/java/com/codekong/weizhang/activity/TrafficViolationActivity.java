package com.codekong.weizhang.activity;
...
public class TrafficViolationActivity extends Activity {
    private final String APPID = "1778";
    private final String APPKEY = "b7de4b047b33b9497d887ef3bb2c4898";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weizhangIntent.putExtra("appId",APPID);// appId
        weizhangIntent.putExtra("appKey", APPKEY);// appKey
        ...
        if (car.getCity_id() > 0) {
            ...
            if (classno > 0) {
                ...
                if (car.getChejia_no().length() != classno) {
                    Toast.makeText(TrafficViolationActivity.this, "输入车架号后" + classno + "位",
            ...
            if (engineno > 0) {
                ...
                if (car.getEngine_no().length() != engineno) {
                    Toast.makeText(TrafficViolationActivity.this,
